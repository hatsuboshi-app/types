...
export default class Effect implements IEffect, EmbeddedObject<IEffect, DBEffect> {
    ...
    static async fromDB(obj: DBEffect, populate: PopulateEffectReference): Promise<Effect> {
...
/**
 * JSON-serializable representation of {@link Effect}.
 *
...
/**
 * Document-store representation of {@link Effect}.
 *

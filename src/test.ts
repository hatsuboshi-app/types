...
import Character, { ICharacter } from "./class/persistent/Character"
...
const kotone: Partial<ICharacter> = {
    ...
    detail: {
        ...
        introduction: {
            ja: "「稼げるアイドル」を目指すムードメーカー。\n中等部からの内部進学組。ダンスの才能に富む。\n学園評価、自己評価ともに低いが、本調子ではないように見える。\nたくさんのアルバイトを掛け持ちしているせいで、いつも疲れているようだ。",
            en: ""
        }
    },
    trueEndBonuses: [
...
const s3Kotone: Partial<IPIdol> = {
    character: new Character(kotone),
    name: {

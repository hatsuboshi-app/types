...
import PIdolLevelEffect, { DBPIdolLevelEffect, IPIdolLevelEffect } from "../transient/PIdolLevelEffect"
import PItem, { DBPItem, IPItem } from "./PItem"
import Ability, { DBAbility, IAbility } from "../transient/Ability"
...
export type DBPIdol = Omit<IPIdol, "character" | "signatureSkill" | "signaturePItem" | "initialAbilities" | "trainingLevels" | "potentialLevels" | "primaStellaUpgrade"> & {
    character: string
